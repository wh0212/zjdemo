                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <router-link :to="'/games/btthk'">
                          <img src="../../assets/static/img/index/carousel_btthk.png" alt="">
                        </router-link>
                    </div>

                    <div class="item">
                        <router-link :to="'/games/fmj16'">
                          <img src="../../assets/static/img/index/carousel_fmj16.jpg" alt="">
                        </router-link>
                    </div>
                    <div class="item">
                        <router-link :to="'/games/fbt'">
                          <img src="../../assets/static/img/index/carousel_fbt.jpg" alt="">
                        </router-link>
                    </div>
          ...
          <div class="bx">
              ...
              <div class="list bx">
                <div class="item"  v-for="(v,i) in initData.userData" :key="i" :style="'background:'+v.bgColor">
                      <div class="icon">
                        <img src="../../assets/static/img/icon_1.png" alt="">
                      </div>
                      <div class="number">
                        <div>
                            <div class="count">
...
<style lang="less" scoped>
  .homePage_wrap {
    ...
    .best-game {
      width: 100%;
      min-height: 798px;
      background: url("../../assets/static/img/background_1.png") repeat center;
      position: relative;
    ...
    .game-data {
      ...
      min-height: 798px;
      font-family: 'Bahnschrift';
      background: url("../../assets/static/img/background_2.png") repeat center;
      padding-bottom:10%;
      .title {
        text-align: center;
        color:#fff;
