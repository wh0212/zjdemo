...
<article class="about" id="step1">
      ...
      <section class="banner container-fluid">
            <img src="../../assets/static/img/about-bg.jpg" alt="">
            <div class="title">
      ...
      <section class="info-list">
          <div class="container-fluid">
            <div class="item  bx">
                  ...
                  <div class="img">
                      <img src="../../assets/static/img/about-list1.png" alt="">
                  </div>
            </div>
          </div>
          <div class="container-fluid" style="background:#fff;">
            <div class="item  bx">
                  <div class="img">
                      <img src="../../assets/static/img/about-list2.png" alt="">
                  </div>
                  <div class="font">
                    <div>
          ...
          <div class="container-fluid">
            <div class="item  bx">
                  ...
                  <div class="img">
                      <img src="../../assets/static/img/about-list3.png" alt="">
                  </div>
            </div>
          </div>
      </section>
      ...
      <section class="office">
          ...
          <div class="photo"><img src="../../assets/static/img/office.png" alt=""></div>
      </section>
   <!--地址-->
