...
<div class="game-list">
      ...
      <section class="banner container-fluid">
          <img src="../../assets/static/img/game-bg.jpg" alt="">
		  <div class="title">
			  <p class="p1">Games</p>
	  ...
	  <!--游戏列表-->
	<section class="list container-fluid" v-for="(v,i) in initData" :style="'background:url(../../assets/static/img/list_bg'+(i%2)+'.png) no-repeat center top'" :key="i">
		<div class="row bx">
			<div class="col-xs-12 col-sm-3 col-md-2  col-lg-2 ">
				...
				<div class="picture">
					...
					<div class="count ec-bounce-in-r">
						<img src="../../assets/static/img/count_box.png" alt="">
						<div class="count-box">
							<!--下载次数-->
					...
					<div class="content">
						...
						<div class="download">
							<a :href="v.appleURL" target="_blank">
								...
								<img v-if="v.appleURL" class="" src="../../assets/static/img/app_store.png" alt="">
							</a>
							<a :href="v.googleURL" target="_blank" style="margin-left:5px">
								<!--<img class="ech-pulse-shrink" src="../../../static/img/google_paly.png" alt="">-->
								<img v-if="v.googleURL" class="" src="../../assets/static/img/google_paly.png" alt="">
							</a>
						</div>
					</div>
			</div>
