			...
			<!--面包屑导航-->
								...
								<div class="breadcrumb-inner container">
										<nav aria-label="breadcrumb">
												<ol class="breadcrumb">
														...
														<li class="breadcrumb-item">
															<router-link to="/game_details">游戏详情</router-link>
														</li>
				...
				<section class="detail">
						<div class="container">
								...
								<figure class="figure">
								  <img src="../../assets/static/img/detial.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
				...
				<section class="back">
					<div class="container">
						<router-link to="/game_details">返回列表</router-link>
					</div>
				</section>
