            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li>
										<ul class="link">
											<li>
												<router-link to=""><img src="../../assets/static/img/youtube.png"/></router-link>
											</li>
											<li>
												<a href="https://www.facebook.com/gameflask/" target="_blank" ><img src="../../assets/static/img/facebook.png"/></a>
											</li>
											<li>
												<router-link to=""><img src="../../assets/static/img/twitter.jpg"/></router-link>
											</li>
											<li>
												<router-link to=""><img src="../../assets/static/img/google.jpg"/></router-link>
											</li>
									</ul>
								</li>
                <li class="dropdown">
