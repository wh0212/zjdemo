...
Page({
      ...
      tt.request({
        ...
        success: (res) => {
          ...
          if (res.data.prob == 1) {
            ...
            var obj = {
              channel: "7",
              appletsName: '测试你会不会成为富翁',
              openid:this.data.openid
            }
            serve('/pages/cai6result/index',obj)
          }
        }
      });
  ...
  onLoad: function (options) {
    ...
    shipin(7,'测试你会不会成为富翁',options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: '/pages/cai6index/index?from=sharebuttonabc&otherkey=othervalue&id=7', // ?后面的参数会在转发页面打开时传入onLoad方法
