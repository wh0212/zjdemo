...
Page({
        ...
        success: res => { // 成功的回调
          ...
          tt.request({
            ...
            success: (res) => {
              ...
              var obj = {
                channel: "44",
                appletsName: '你是不是一个主动的人',
                openid: this.data.openid
              }
              serve('/pages/xg3result/index', obj)
            }
          });
        }
      })
  ...
  onLoad: function (options) {
    ...
    shipin(44, '你是不是一个主动的人', options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: 'pages/xg3index/index?from=sharebuttonabc&otherkey=othervalue&id=44', // ?后面的参数会在转发页面打开时传入onLoad方法
