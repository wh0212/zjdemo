...
Page({
  ...
  onLoad: function (options) {
    ...
    shipin(46, '你有当老板的潜质吗', options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: 'pages/xg5index/index?from=sharebuttonabc&otherkey=othervalue&id=46', // ?后面的参数会在转发页面打开时传入onLoad方法
