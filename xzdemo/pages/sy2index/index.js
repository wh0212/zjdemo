...
Page({
  ...
  onLoad: function (options) {
    ...
    shipin(53,'同事对你的偏见有多大',options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: '/pages/sy2index/index?from=sharebuttonabc&otherkey=othervalue&id=53', // ?后面的参数会在转发页面打开时传入onLoad方法
