...
Page({
  ...
  onLoad: function (options) {
    ...
    shipin(47,'测试你的财运在哪里',options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: '/pages/cai4index/index?from=sharebuttonabc&otherkey=othervalue&id=47', // ?后面的参数会在转发页面打开时传入onLoad方法
