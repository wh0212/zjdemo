...
Page({
      ...
      tt.request({
        ...
        success: (res) => {
          ...
          if (res.data.prob == 1) {
            ...
            var obj = {
              channel: "18",
              appletsName: '测试你的事业贵人',
              openid: this.data.openid
            }
            serve('/pages/sy2result/index', obj)
          }
        }
      });
  ...
  onLoad: function (options) {
    ...
    shipin(18, '测试你的事业贵人',options.openid)
  },
  onShareAppMessage(option) {
    ...
    return {
      ...
      path: '/pages/sy2index/index?from=sharebuttonabc&otherkey=othervalue&id=18', // ?后面的参数会在转发页面打开时传入onLoad方法
